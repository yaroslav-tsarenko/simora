      ...
      <AnimatedSection className="w-full max-w-md">
        <div className="rounded-2xl border border-border bg-white p-8 shadow-sm">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-text-light">Sign in to your Simora account</p>
          </div>

          <div className="mb-6 rounded-xl bg-accent/5 border border-accent/20 p-4">
            <p className="text-sm text-text-light">
              <span className="font-semibold text-accent">Test credentials:</span><br />
              Email: <code className="text-text font-mono text-xs bg-surface px-1 py-0.5 rounded">test@gmail.com</code><br />
              Password: <code className="text-text font-mono text-xs bg-surface px-1 py-0.5 rounded">test123!</code>
            </p>
          </div>
